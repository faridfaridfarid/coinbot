package fr.gafj.coinbot.web.rest;

import fr.gafj.coinbot.config.Constants;
import fr.gafj.coinbot.CoinbotApp;
import fr.gafj.coinbot.domain.Authority;
import fr.gafj.coinbot.domain.User;
import fr.gafj.coinbot.repository.AuthorityRepository;
import fr.gafj.coinbot.repository.UserRepository;
import fr.gafj.coinbot.security.AuthoritiesConstants;
import fr.gafj.coinbot.service.MailService;
import fr.gafj.coinbot.service.dto.UserDTO;
import fr.gafj.coinbot.web.rest.errors.ExceptionTranslator;
import fr.gafj.coinbot.web.rest.vm.KeyAndPasswordVM;
import fr.gafj.coinbot.web.rest.vm.ManagedUserVM;
import fr.gafj.coinbot.service.UserService;
...
@SpringBootTest(classes = CoinbotApp.class)
